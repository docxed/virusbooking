...
// describe('buybeds validate testing', () => {
//     it('should alert login success & show main page & should alert invalid date', () => {
//         cy.visit('https://murmuring-retreat-81100.herokuapp.com/login')
//         cy.get('[type="email"]').type('test@gmail.com').should('have.value', 'test@gmail.com')
//         cy.get('[type="password"]').type('Passw0rd').should('have.value', 'Passw0rd')
//         cy.get('.btn').click()
...
//     it('should alert login success & show main page & should show beds page', () => {
//         cy.visit('https://murmuring-retreat-81100.herokuapp.com/login')
//         cy.get('[type="email"]').type('test@gmail.com').should('have.value', 'test@gmail.com')
//         cy.get('[type="password"]').type('Passw0rd').should('have.value', 'Passw0rd')
//         cy.get('.btn').click()
