...
describe('ทดสอบว่าหน้า main มีการแสดงผล component ที่เกี่ยวข้องกับการค้นหาและจองเตียงครบถ้วนหรือไม่', () => {
    ...
    it('- ทำการตรวจสอบ component ในหน้า main หลังทำการ login ว่ามีครบถ้วนหรือไม่', () => {
        cy.get('.me-auto > :nth-child(2) > .nav-link').should("have.text", " ค้นหาเตียง")
        cy.get('.me-auto > :nth-child(3) > .nav-link').should("have.text", " การจองเตียง")
...
describe('ทดสอบว่าในหน้าค้นหาเตียง มีการแสดงผล component ตามที่ต้องการครบถ้วนหรือไม่', () => {
    it("- ทำการ login เพื่อเข้าสู่หน้าค้นหาเตียง", () => {
        ...
        cy.wait(5000)
        cy.url().should("eq", "https://murmuring-retreat-81100.herokuapp.com/findbeds")
    })
    ...
    it("- ตรวจสอบช่องเลือกจังหวัดว่ามีข้อมูลครบถ้วนแล้ว", () => {
        const allProvince = "ทุกจังหวัดกรุงเทพฯกระบี่กาญจนบุรีกาฬสินธุ์กำแพงเพชรขอนแก่นจันทบุรีฉะเชิงเทราชลบุรีชัยนาทชัยภูมิชุมพรเชียงใหม่เชียงรายตรังตราดตากนครนายกนครปฐมนครพนมนครราชสีมานครศรีธรรมราชนครสวรรค์นนทบุรีนราธิวาสน่านบึงกาฬบุรีรัมย์ปทุมธานีประจวบคีรีขันธ์ปราจีนบุรีปัตตานีพระนครศรีอยุธยาพะเยาพังงาพัทลุงพิจิตรพิษณุโลกเพชรบุรีเพชรบูรณ์แพร่ภูเก็ตมหาสารคามมุกดาหารแม่ฮ่องสอนยโสธรยะลาร้อยเอ็ดระนองระยองราชบุรีลพบุรีลำปางลำพูนเลยศรีสะเกษสกลนครสงขลาสตูลสมุทรปราการสมุทรสงครามสมุทรสาครสระแก้วสระบุรีสิงห์บุรีสุโขทัยสุพรรณบุรีสุราษฎร์ธานีสุรินทร์หนองคายหนองบัวลำภูอ่างทองอำนาจเจริญอุดรธานีอุตรดิตถ์อุทัยธานีอุบลราชธานี"
